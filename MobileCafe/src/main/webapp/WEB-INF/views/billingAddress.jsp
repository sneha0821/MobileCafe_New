...
<div class="container" style="min-height: 700px;">
      <div class="row">
        <article class="span8">
          <h3><font color="ffffff">Enter your Billing Address</font></h3>
          <div class="inner-1">
            <form:form action="checkout" commandName="Address">
                ...
                <div>
                  <label class="message">
                    ...
                    <br>
                    <span class="error"><font color="ffffff">*Enter address with pincode</span> <span class="empty">*This field is required.</span></font> </label>
                </div>
